        ...
        <div className="w-full max-w-md mx-auto">
            ...
            >
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-display font-bold text-white mb-2">Wachtwoord Resetten</h1>
                    <p className="text-white/60">Kies een nieuw veilig wachtwoord voor je account.</p>
                </div>

                {status === 'loading' && (
                    <div className="text-center py-10">
                        <div className="animate-spin w-8 h-8 border-4 border-brand-orange border-t-transparent rounded-full mx-auto mb-4"></div>
                        <p className="text-white/50">Token controleren...</p>
                    </div>
                )}
                ...
                {status === 'success' && (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 text-center">
                        ...
                        <h3 className="text-white font-bold text-xl mb-2">Wachtwoord Aangepast!</h3>
                        <p className="text-white/60 mb-6">Je kunt nu inloggen met je nieuwe wachtwoord.</p>
                        <a
                            href="/login"
                ...
                {status === 'input' && (
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-white/80 ml-1">Nieuw Wachtwoord</label>
                            <input
                                type="password"
                                {...register("password")}
                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-white/20 focus:outline-none focus:border-brand-orange/50 focus:ring-1 focus:ring-brand-orange/50 transition-all"
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-white/80 ml-1">Bevestig Wachtwoord</label>
                            <input
                                type="password"
