...
import { User, Mail, MapPin, Users, HeartHandshake, CheckCircle2, ChevronRight, Phone, Contact, Camera } from "lucide-react";
...
export default function RegisterForm() {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            // Generate a secure random password for the backend (Guest Registration)
            ...
            await registerParticipant({
                ...
                password: autoGeneratedPassword, // Pass generated password
            });
